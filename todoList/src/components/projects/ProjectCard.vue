<template>
  <div
    ...
    class="flex items-center gap-4 px-4 py-3 rounded-md border-l-4 hover:bg-gray-50 cursor-pointer transition group"
  >
    <svg
      width="14"
      height="13"
    ...
    <button
      ...
      class="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-md transition opacity-0 group-hover:opacity-100 flex-shrink-0"
